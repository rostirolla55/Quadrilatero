...
def update_main_js(repo_root, page_id, nav_key_id, lat, lon, distance):
    ...
    # Aggiunta virgola finale per mantenere l'array JS valido
    ...
    try:
        ...
        with open(js_path, "w", encoding="utf-8") as f:
            f.write(content)
            print("✅ main.js aggiornato con successo.")
...
def update_html_files(repo_root, page_id, nav_key_id, translations, page_title_it):
    ...
    # 1. Creazione file HTML (tutti con suffisso lingua)
    for lang in LANGUAGES:
        ...
        if not os.path.exists(new_path):
            ...
            # Switcher lingua (tutti puntano a -lang.html)
