    ...
    for lang in LANGUAGES:
        ...
        try:
            ...
            if page_id not in data:
                ...
                # Se la pagina esiste, aggiorna solo i campi mancanti e la data
                for key, val in NEW_PAGE_SCHEMA.items():
                    if key not in data[page_id]:
                        data[page_id][key] = val
...
def generate_language_switcher(page_id, current_lang):
    ...
    for lang in LANGUAGES:
        ...
        # I file sono generati con suffisso lingua (es: cavaticcio-it.html)
...
def update_html_files(repo_root, page_id, nav_key_id, translations, page_title_it):
    ...
    for lang in LANGUAGES:
        ...
        if not os.path.exists(new_path):
            ...
            # Utilizzo della funzione dedicata per lo switcher
